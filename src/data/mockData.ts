  ...
  ctv: [
    {
      id: 'ctv-takeover',
      title: 'CTV Takeover',
      description: 'Full-screen immersive ad experience during streaming content',
  ...
  openweb: [
    {
      ...
      imageUrl: 'https://images.pexels.com/photos/3182746/pexels-photo-3182746.jpeg',
    },
    {
      id: 'runway',
      title: 'Runway',
    ...
    },
    {
      id: 'breakout',
      title: 'Breakout',
      description: 'Attention-grabbing format that expands beyond standard units',
...
export const mockDomainPerformance = [
  ...
  { domain: 'lifestyle-magazine.com', impressions: 750000, ctr: 2.4, spend: 9000 },
  { domain: 'entertainment-daily.com', impressions: 650000, ctr: 1.9, spend: 8000 },
];